...
public class ArticleVo {
	...
	public String toString() {
		return "DataTradeVo [artcl_no=" + artcl_no + ", artcl_bc=" + artcl_bc + ", artcl_complx=" + artcl_complx
				+ ", artcl_nm=" + artcl_nm + ", artcl_excv_area=" + artcl_excv_area + ", artcl_ty=" + artcl_ty
				+ ", artcl_prps_pls=" + artcl_prps_pls + ", artcl_mn_prps=" + artcl_mn_prps + ", artcl_flr=" + artcl_flr
				+ ", artcl_const_y=" + artcl_const_y + ", artcl_gu=" + artcl_gu + ", artcl_dong=" + artcl_dong
				+ ", artcl_zip=" + artcl_zip + ", artcl_rd=" + artcl_rd + ", artcl_rd_detail=" + artcl_rd_detail
				+ ", artcl_lat=" + artcl_lat + ", artcl_lng=" + artcl_lng + "]";
	}

	public int getArtcl_no() {
		return artcl_no;
	}

	public void setArtcl_no(int artcl_no) {
		this.artcl_no = artcl_no;
	}
	...
	public float getArtcl_excv_area() {
		return artcl_excv_area;
	}

	public void setArtcl_excv_area(float artcl_excv_area) {
		this.artcl_excv_area = artcl_excv_area;
	}
	...
	public String getArtcl_flr() {
		return artcl_flr;
	}

	public void setArtcl_flr(String artcl_flr) {
		this.artcl_flr = artcl_flr;
	}
